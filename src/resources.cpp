...
*/
    ...
    //! Indique le chemin d'accès aux resources sons.
    //! \return une chaîne de caractères contenant le chemin absolu du répertoire des sons.
    QString soundsPath() {
        return resourcesPath() + QString("sounds") + QDir::separator();
    }
}
